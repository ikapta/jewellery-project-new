...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="product_data" class="product_data registerform" runat="server">
        <div id="bott_table">
                    ...
                    <p class ="noshow" id="error">此珠宝已存在!</p>
            <table  style="border-collapse:collapse;width:800px;margin:0 auto;height:230px">
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td style="width:205px;"><input runat="server" id="projia" type="text" value="" name="name" class="user_input" datatype="*" errormsg="不能为空！" /></td>
                    <td><div class="Validform_checktip"></div></td>
                ...
                <tr>
                    <td colspan="3" style="text-align:center">
                        <asp:Button ID="Button1" runat="server" style="width: 180px;height: 30px;background-color: azure;margin-right: 209px;margin-top: 20px;" Text="添加" OnClick="Button1_Click" />
